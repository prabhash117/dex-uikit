...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 120 29" }, props),
        React__default['default'].createElement("image", { width: "100%", href: isDark ? "/images/egg/LogoTextNewDark.png" : "/images/egg/LogoTextNewWhite.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { style: { justifyContent: "center", alignItems: "center" } },
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, priceLink = _a.priceLink, socialsLinks = _a.socialsLinks;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        ...
        React__default['default'].createElement(SettingsEntry, { className: "dark-light" },
...
var ConnectModal = function (_a) {
    ...
    var _c = React.useState(false), onlyMetaMask = _c[0], setOnlyMetaMask = _c[1];
    React.useEffect(function () {
        var onlyMetaMask = localStorage.getItem("onlyMetaMask");
...
var NetworkModal = function (_a) {
    var networks = _a.networks, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    var _c = React.useState(false); _c[0]; var setOnlyMetaMask = _c[1];
    React.useEffect(function () {
        var onlyMetaMask = localStorage.getItem("onlyMetaMask");
        if (onlyMetaMask === "true") {
            setOnlyMetaMask(true);
    ...
    return (React__default['default'].createElement(Modal, { title: "Select Network", onDismiss: onDismiss },
        React__default['default'].createElement(React__default['default'].Fragment, null, networks && networks.map(function (entry, index) { return (React__default['default'].createElement(NetworkCard, { key: entry.label, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }))));
};
...
var useWalletModal = function (login, logout, account, networks) {
    ...
    var onPresentNetworkModal = useModal(React__default['default'].createElement(NetworkModal, { networks: networks }))[0];
    return { onPresentConnectModal: onPresentConnectModal, onPresentAccountModal: onPresentAccountModal, onPresentNetworkModal: onPresentNetworkModal };
};

var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout, networks = _a.networks;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, networks: networks }),
                profile && React__default['default'].createElement(Avatar, { profile: profile }))),
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, socialsLinks: socialsLinks }),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#011e1e", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
